...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        imageView.animationImages=[NSArray arrayWithObjects:
                                   [UIImage imageNamed:@"shopOne"],
                                   [UIImage imageNamed:@"shopTwo"],
                                   [UIImage imageNamed:@"shopThree"],
                                   [UIImage imageNamed:@"shopFore"],
                                   [UIImage imageNamed:@"shopFive"],
                                   [UIImage imageNamed:@"shopSix"],
                                   nil ];
//        imageView.animationImages=[NSArray arrayWithObjects:
