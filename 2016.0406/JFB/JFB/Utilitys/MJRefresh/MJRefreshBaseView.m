...
@interface  MJRefreshBaseView()
{
    ...
    __weak CustomActivityIndicatorView *_activityView;
    BOOL _endingRefresh;
}
@end
...
//        activityView.autoresizingMask = self.arrowImage.autoresizingMask;
        CustomActivityIndicatorView *activityView = [[CustomActivityIndicatorView alloc] initWithFrame:CGRectMake(100, 100, 20, 20)];
