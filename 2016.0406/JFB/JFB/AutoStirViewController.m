...
@property (nonatomic,strong) UIButton  *lableNumber2;
@property (nonatomic,strong) UIButton *lableNumber1;
...
- (void)fangfaAa:(NSInteger)aa bb:(NSInteger)bb
{
    ...
    if (self.photoName.count >= aa && self.photoName.count >= bb) {
        ...
        if (!_lableNumber1) {
//            UIImageView *img1=[[UIImageView alloc]initWithFrame:(CGRectMake(self.frame.size.width-60,_imageView2.frame.size.height-40, 40, 30))];
//            img1.backgroundColor=[UIColor redColor];
//            [_scroll1 addSubview:img1];
            _lableNumber1=[UIButton buttonWithType:UIButtonTypeCustom];
            _lableNumber1.frame = CGRectMake(self.frame.size.width-60,_imageView2.frame.size.height-40, 40, 25);// 数字标签
//            _lableNumber1.backgroundColor = [UIColor clearColor];
            [_lableNumber1 setBackgroundImage:[UIImage imageNamed:@"photo_IM"] forState:UIControlStateNormal];
            _lableNumber1.titleLabel.font = [UIFont boldSystemFontOfSize:18];
//            _lableNumber1.titleLabel.textColor=[UIColor blackColor];
            [_lableNumber1 setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_scroll1 addSubview:_lableNumber1];
        }
        NSString *string = [NSString stringWithFormat:@"%ld/%lu",aa+1,(unsigned long)[_photoName count]];
//        _lableNumber1.titleLabel.text = string;
        [_lableNumber1 setTitle:string forState:UIControlStateNormal];
        NSLog(@"%@",_lableNumber1.titleLabel.text);
        
        if (!_lableNumber2) {
            _lableNumber2=[UIButton buttonWithType:UIButtonTypeCustom];
            _lableNumber2.frame = CGRectMake(self.frame.size.width-60,_imageView1.frame.size.height-40, 60, 25);// 数字标签
            //            _lableNumber1.backgroundColor = [UIColor clearColor];
            [_lableNumber2 setBackgroundImage:[UIImage imageNamed:@"photo_IM"] forState:UIControlStateNormal];
            _lableNumber2.titleLabel.font = [UIFont boldSystemFontOfSize:18];
//            _lableNumber2.titleLabel.textColor=[UIColor blackColor];
            [_lableNumber2 setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
//            _lableNumber2.font = [UIFont systemFontOfSize:18];
            [_scroll2 addSubview:_lableNumber2];
        }
      //  NSString *string2 = [NSString stringWithFormat:@"%ld/%lu",bb+1,(unsigned long)[_photoName count]];
//        _lableNumber2.titleLabel.text = string2;
        [_lableNumber2 setTitle:string forState:UIControlStateNormal];
    }
